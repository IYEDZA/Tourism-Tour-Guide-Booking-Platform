  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 px-6 py-20 text-white">
      <motion.div
        ...
        className="max-w-5xl mx-auto bg-base-100 p-10 rounded-2xl shadow-2xl border border-accent animate-pulse-slow"
      >
        <h2 className="text-4xl font-extrabold text-center text-accent mb-10 animate-pulse tracking-wide">
          <FaBook className="inline-block mr-2 text-accent-content" /> Share Multiple Travel Stories
        </h2>

        ...
        <div>
           ...
           */}
                ...
                <motion.h2
                  ...
                  transition={{ duration: 0.6 }}
                  className="text-2xl md:text-2xl font-bold text-center mb-12 flex items-center justify-center gap-3 "
                >
                  <FaImage className="text-primary animate-spin-slow" />
              ...
              >
                ...
                <div className="space-y-3">
                  <h2 className="text-xl font-semibold mt-5">Tour Guides</h2>
           ...
           {
                user?.email?( <Link to={`/booking/${_id}`}><button  className="btn btn-primary w-full mt-4">
                    Book Now
                  </button></Link> ):( <Link to='/login'><button className="btn btn-accent w-full mt-4">
